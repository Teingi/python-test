...
=================================
		...
		2、chapter02—————《数据挖掘入门与实践》第二章  用scikit-learn库提供的几个方法，创建了运行和评估数据挖掘模型的标准工作流（近邻算法）
		3、chapter04————— 用pandas加载数据集分析百万电影数据
		4、chapter08—————《数据挖掘入门与实践》第八章  创建验证码和字母数据集，利用神经网络库PyBrain构建具有高精度的字母分类器来识别单词，实现验证码破解功能