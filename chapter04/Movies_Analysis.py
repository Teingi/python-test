...
#top_10_mean_ratings = mean_ratings_by_title.sort_values(ascending=False,by= 'title').head(10)
#print(top_10_mean_ratings)


#评分人数最多的10部电影的平均评分.
#print(mean_ratings_by_title[top_10_total_rating.index])
################################################################
